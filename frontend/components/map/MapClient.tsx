  ...
  return (
    <div className="space-y-4">
      <div className="nm-card rounded-[1.6rem] p-4 text-sm">
        <p className="uppercase tracking-[0.2em] text-gold-400">Всего точек: {markers.length}</p>
        <p className="mt-2 uppercase tracking-[0.2em] text-white/72">Ваши точки: {ownMarkersCount}</p>
      </div>
